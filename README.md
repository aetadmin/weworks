<h1 align="center">Welcome to WeWorks Ticket Management 🍵</h1>
<p align="center">
...
Check out the getting started guide if this is the first time you've used WeWorks:
...
- We are now on linode marketplace we can be viewed here <a href="https://www.linode.com/marketplace/apps/weworks-lab/weworks/">here</a>
- We have a one line installer for Ubuntu and Debian (for the moment) and can be viewed here <a href="https://weworks.sh/">here</a>

## Documentation

We have started working on creating documentation for WeWorks which covers development to general usage. Click <a href="https://docs.weworks.sh">here</a> to be taken directly there.
...
- Website: [weworks.sh](https://weworks.sh/)
